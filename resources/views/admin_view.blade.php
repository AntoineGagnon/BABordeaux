...
@section('content')
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="btn-group-vertical btn-group-lg col-lg-12 col-xs-12 col-md12 col-sm-12" role="group" aria-label="...">
                <a href="/admin/editpoll" type="button" class="btn btn-default btn-danger btn-block">Editer le questionnaire</a>
                <a href="/admin/resultpoll" type="button" class="btn btn-default btn-info btn-block" >Visualiser les résultats du questionnaire</a>
