                ...
                <div class="col-md-12">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <form action="/question" method="POST">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="num_group_questions">Numéro du groupe de
                                                        question: </label>
                                                    <select class="form-control" id="num_group_questions"
                                                            name="num_group_questions">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div id="choices-group" class="form-group">
                                                    <input type="text" class="form-control choice" name="choice0"
                                                           placeholder="choix" style="display:none"/>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label for="is_required_true"> Oui </label><input type="radio"
                                                                                                      name="is_required"
                                                                                                      required
                                                                                                      value="1"/>
                                                    <label for="is_required_false"> Non </label><input type="radio"
                                                                                                       name="is_required"
                                                                                                       value="0"/>
                                                </div>
                                            </div>
                                ...
                                <input value="0" type="number" class="form-control" id="nb_choices" name="nb_choices"
                                       style="display: none"/>
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <span class="glyphicon glyphicon-th-list"></span>MODIFIER OU SUPPRIMER DES
                                    QUESTIONS</a>
                                </h4>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse in ">
