...
class Style
{
     ...
     * @var bool
     */
    public $_has_border_radius = false; // stylesheet this style is attached to
    /**
     ...
     * @var array
     */
    protected $_prop_cache; // Font size of parent element
    /**
     ...
     * @var int
     */
    protected $_origin = Stylesheet::ORIG_AUTHOR; // Cache flag
    /**
